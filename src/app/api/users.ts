...
export async function apiUpdateUser(id: string, data: Partial<{ name: string; phone: string; password: string; role: string; vehicleName: string }>): Promise<Omit<User, 'password'>> {
